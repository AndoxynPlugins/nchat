...
public abstract class CommandExecutorBase implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (cmd.getName().equalsIgnoreCase("pd")) {
            ...
            runCommand(sender, cmd, label, commandName, getSubArray(args));
            return true;
        }
        return false;
    }

    abstract public void runCommand(CommandSender sender, Command cmd, String commandLabel, String aliasLabel, String[] subArgs);
}
